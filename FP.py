...
def load_symbols_from_excel(file_path):
    try:
        ...
        symbols = df['Symbol'].apply(lambda x: f"NSE:{x}-EQ").tolist()  
        return symbols
...
def store_stock_data(symbol, ltp, timestamp):
 ...
 #5-minute and 10-minute values from MySQL
...
if validated_symbols:
    access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.._nYz4HPcK0Y8fgRScG02Pw8yD6pPMeMQWhUktPXht8I"
